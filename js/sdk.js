/*1608114345,,JIT Construction: v1003109802,en_US*/
...
})("https:\/\/connect.facebook.net\/en_US\/sdk.js?hash=81a93dc25722bbf74bd5887e91a2fed5", 1608114345, "FB", ["AppEvents.EventNames", "AppEvents.ParameterNames", "AppEvents.activateApp", "AppEvents.clearAppVersion", "AppEvents.clearUserID", "AppEvents.getAppVersion", "AppEvents.getUserID", "AppEvents.logEvent", "AppEvents.logPageView", "AppEvents.logPurchase", "AppEvents.setAppVersion", "AppEvents.setUserID", "AppEvents.updateUserProperties", "Canvas.Plugin.showPluginElement", "Canvas.Plugin.hidePluginElement", "Canvas.Prefetcher.addStaticResource", "Canvas.Prefetcher.setCollectionMode", "Canvas.getPageInfo", "Canvas.scrollTo", "Canvas.setAutoGrow", "Canvas.setDoneLoading", "Canvas.setSize", "Canvas.setUrlHandler", "Canvas.startTimer", "Canvas.stopTimer", "Event.subscribe", "Event.unsubscribe", "XFBML.parse", "addFriend", "api", "getAccessToken", "getAuthResponse", "getLoginStatus", "getUserID", "init", "login", "logout", "publish", "share", "ui"], true);

/*1608103016,,JIT Construction: v1003109329,en_US*/
...
try {
        ...
        (function () {
            ...
            with (this) {
                ...
                __d("ES5ArrayPrototype", [], (function (a, b, c, d, e, f) {
                    ...
                    g.filter = function (a, b) {
                        ...
                        var c,
                            ...
                            f = [];
                        for (c = 0; c < e; ++c)
                            c in this && (d = this[c], a.call(b, d, c, this) && f.push(d));
                        return f
                    };
                        ...
                        h = function () {
                            ...
                            function o(a, b) {
                                if (r(b)) {
                                    ...
                                    c = k + b;
                                    if (typeof b === "string")
                                        return a._stringIndex[c];
                                    else
                                        return a._otherIndex[c]
                                }
                            }
                            function p(a, b, c) {
                                var d = c == null;
                            ...
                            function t(b) {
                                if (!a.__isES5 || !Object.isExtensible)
                                    return !0;
                                else
                            ...
                            function w(b) {
                                ...
                                else if (!a.__isES5 && e(b) && u(b))
                                    return u(b);
                                else if (!a.__isES5 && b[v])
                                    return b[v]
                            }
                            var x = function () {
                        ...
                        function f(c, f) {
                            return function () {
                                ...
                                try {
                                    ...
                                    if (a instanceof b("ManagedError"))
                                        throw a;
                    ...
                    function a(a, c) {
                        ...
                        ES(ES("Object", "keys", !1, c), "forEach", !0, function (b) {
                            ...
                            if (typeof e === "function") {
                                ...
                                (typeof e === "object" || typeof e === "number") && (d[b] = e)
                        })
                    }
                ...
                __d("URIAbstractBase", ["invariant", "URIRFC3986", "URISchemes", "setHostSubdomain"], (function (a, b, c, d, e, f, g) {
                    ...
                    a = function () {
                        ...
                        a.parse = function (c, d, e, f) {
                            ...
                            if (!c.getDomain() && ES(c.getPath(), "indexOf", !0, "\\") !== -1) {
                                if (e)
                    ...
                    function a(a) {
                        ...
                        if (typeof a === "string")
                            if (b("sdk.Runtime").getIsVersioned()) {
                                ...
                                b("ApiClient").graph.apply(b("ApiClient"), arguments);
                        else
                            b("ApiClient").rest.apply(b("ApiClient"), arguments)
                    }
                    e.exports = a
                }), null);
                ...
                __d("FBEventsParamList", [], (function (a, b, c, d, e, f) {
                    ...
                    e.exports = a;
                    function i(a) {
                        if (typeof JSON === "undefined" || JSON === null || !ES("JSON", "stringify", !1))
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function (a, b, c, d, e, f) {
                    ...
                    function E(a) {
                        ...
                        for (var c in a)
                            b("Assert").isTrue(l.test(c) || ES(r, "includes", !0, c), "Invalid user properties key name: " + c + ". It must be between 1 and " + m + " characters, and must contain only alphanumerics, _, - or spaces, starting with alphanumeric or _. Or, it must be a pre-defined user property"),
                ...
                __d("sdk.Auth", ["Log", "ObservableMixin", "QueryString", "UrlMap", "sdk.Cookie", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.WebStorage"], (function (a, b, c, d, e, f) {
                    var g = "fblst_",
                        ...
                        p,
                        q,
                        r = new (b("ObservableMixin"))();
                    b("sdk.Runtime").subscribe("AccessToken.change", function (a) {
                        !a && b("sdk.Runtime").getLoginStatus() === "connected" && r.getLoginStatus(null, !0)
                    });
                    function s(a, c, d) {
                        d === void 0 && (d = !1);
                        ...
                        if (a != null) {
                            ...
                            b("sdk.Runtime").getUseCookie() && b("sdk.Cookie").clearSignedRequestCookie(),
                                b("sdk.Runtime").getUseLocalStorage() && y();
                        ...
                        (j || e) && r.inform("logout", g);
                        (i || e) && r.inform("login", g);
                        m && r.inform("authresponse.change", g);
                        f && r.inform("status.change", g);
                    ...
                    function c(a, c, d, e) {
                        return function (d) {
                            if (d && d.access_token) {
                                ...
                                d && d.asset_scopes ? (c = {
                                    asset_scopes: ES("JSON", "parse", !1, d.asset_scopes)
                                }, c = x(c, d), z(), f = "connected", s(c, f), w(e)) : d && d.error === "access_denied" ? (A(), f = "unknown", s(null, f)) : d && d.result && (z(), c = d.result.authResponse);
                            if (a) {
                                f = {
                                    authResponse: c,
                                    status: b("sdk.Runtime").getLoginStatus()
                    ...
                    function w(a) {
                        ...
                        a = {
                            ...
                            cbt_delta: ES("Date", "now", !1) - d
                        };
                        b("sdk.Impressions").log(o, {
                            payload: a
                        });
                        window.setTimeout(function () {
                            var a = {
                    ...
                    function x(a, c) {
                        ...
                        c.base_domain != null && u(c.base_domain);
                        v(c.graph_domain);
                    ...
                    function z() {
                        b("sdk.Cookie").setRaw(i, "", 0, !1),
                            b("sdk.Cookie").setRaw(i, "", 0, !0)
                    }
                    function A() {
                    ...
                    function D(a) {
                        ...
                        var l = (e = d) != null ? e : f;
                        window.location.protocol !== "https:" && B(a);
                    ...
                    function F(a, c, d) {
                        switch (c) {
                            case "connected":
                                ...
                                d.base_domain != null && u(d.base_domain);
                                v(d.graph_domain);
                    ...
                    function d(c, d, a) {
                            ...
                            d && (d.open("GET", f.toString(), !0), d.withCredentials = !0, d.onreadystatechange = function () {
                                if (d.readyState === 4) {
                                    if (b("sdk.feature")("e2e_ping_tracking", !0)) {
                                        ...
                                        b("sdk.Impressions").log(n, {
                                            payload: f
                                        })
                                    }
                                    if (d.status === 200) {
                                        F(c, (f = d.getResponseHeader("fb-s")) != null ? f : "unknown", (f = d.getResponseHeader("fb-ar")) != null ? f : "{}")
                                    } else
                                        G(c, d.status, a)
                                }
                            }, d.send())
                        ...
                        function h() {
                            window.fetch(f.toString(), {
                                ...
                                if (b.status === 200) {
                                    var d;
                                    F(c, (d = b.headers.get("fb-s")) != null ? d : "unknown", (d = b.headers.get("fb-ar")) != null ? d : "{}")
                                } else
                                    G(c, b.status, a)
                            })["catch"](function (b) {
                                return G(c, 0, a)
                    ...
                    function f(a, c) {
                                ...
                                if (d != null)
                                    try {
                                        ...
                                        if (d != null && d.expiresAt != null && d.expiresAt > ES("Date", "now", !1)) {
                                            var e;
                                            H = "loaded";
                                            s(d.authResponse, (e = d.status) != null ? e : "unknown", !0);
                                            q = window.setTimeout(function () {
                                                D(function () { })
                        ...
                        if (!c)
                            if (H === "loaded") {
                                ...
                                a && r.subscribe("FB.loginStatus", a);
                                return
                            }
                        a && r.subscribe("FB.loginStatus", a);
                        H = "loading";
                        d = function (a) {
                            H = "loaded",
                                r.inform("FB.loginStatus", a),
                                r.clearSubscribers("FB.loginStatus")
                        };
                        D(d)
                    }
                    ...
                    var m = b("Type").extend({
                        ...
                        n = {
                            ...
                            _findRoot: function (a) {
                                a = a;
                                while (a) {
                                    if (b("sdk.DOM").containsCss(a, "fb_dialog"))
                                        return a;
                    ...
                    var g = {
                        ...
                        isAllowed: function (a) {
                            if (!a)
                                return !1;
                            if (typeof a === "number")
                                return a in g._allowedRecipients;
                        ...
                        switch (a.xd_action) {
                            case "plugin_ready":
                                if (typeof a.name === "string") {
                                    ...
                                    b("Log").error("plugin_ready message received without a name");
                                break
                        }
                        a.data != null && (typeof a.data === "object" || typeof a.data === "string") && r(a.data, c)
                    }
                    function r(a, c) {
                        if (c != null && c !== "native" && !b("isFacebookURI")(new (b("sdk.URI"))(c)))
                            return;
                        if (typeof a === "string") {
                            if (/^FB_RPC:/.test(a)) {
                                            ...
                                            e.closed ? d.method === "permissions.oauth" ? b("sdk.Auth").getLoginStatus(function (a) {
                                                a.status === "connected" && d.params != null && d.params.return_scopes ? b("sdk.api")("/me/permissions", function (b) {
                                                    ...
                                                    for (var e = 0; e < b.data.length; e++)
                                                        b.data[e].status === "granted" && (d !== "" && (d += ","), d += b.data[e].permission);
                        ...
                        _xdChannelHandler: function (a, c) {
                            return b("sdk.XD").handler(function (c) {
                                ...
                                if (c.type == "resize")
                                    ...
                                    c.type == "fireevent" && b("sdk.Event").fire(c.event, c)
                            }, c, !0, null)
                        },
                        ...
                        _xdRecv: function (a, c) {
                            ...
                            if (d)
                                if (d.close)
                                    ...
                                    b("sdk.DOM").containsCss(d, "FB_UI_Hidden") ? window.setTimeout(function () {
                ...
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig", "sdk.api", "sdk.Runtime"], (function (a, b, c, d, e, f) {
                    ...
                    function a() {
                        if (!b("sdk.Runtime").isEnvironment(b("sdk.Runtime").ENVIRONMENTS.CANVAS) || !b("sdk.Runtime").getClientID() || !h)
                            return;
                        if (Math.random() >= 1 / h || i == "*" || ~ES(i, "indexOf", !0, b("sdk.Runtime").getClientID()))
                            return;
                        setTimeout(l, 3e4)
                    }
                    function c(a) {
                ...
                __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f) {
                    ...
                    function h(a) {
                        ...
                        if (b("sdk.Runtime").getIsVersioned()) {
                            ...
                            if (a.authResponse)
                                throw new (b("ManagedError"))("Setting authResponse is not supported");
                            ...
                            /number|string/.test(typeof a) && (b("Log").warn("FB.init called with invalid parameters"), a = {
                                apiKey: a
                            }),
                ...
                __d("XFBML", ["Assert", "Log", "ObservableMixin", "runOnce"], (function (a, b, c, d, e, f) {
                    ...
                    function n(a) {
                        ...
                        if (b.length === 0)
                            return void 0;
                        if (a.getAttribute("fb-xfbml-state") || !a.childNodes || a.childNodes.length === 0 || a.childNodes.length === 1 && a.childNodes[0].nodeType === 3 || a.children.length === 1 && k(a.children[0], "className") === "fb-xfbml-parse-ignore")
                            return h[b[0]]
                    }
                    function o(a) {
                        var b = {};
                    ...
                    function p(a, c, d) {
                        ...
                        var f = 1,
                            ...
                            h = function () {
                                f--,
                                    f === 0 && (b("Log").info("XFBML Parsing Finish %s, %s tags found", e, g), c(), j.inform("render", e, g)),
                        ...
                        ES(ES("Array", "from", !1, a.getElementsByTagName("*")), "forEach", !0, function (a) {
                            if (!d && a.getAttribute("fb-xfbml-state"))
                                return;
                            if (a.nodeType !== 1)
                                return;
                            var c = m(a) || n(a);
                ...
                __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike"], (function (a, b, c, d, e, f) {
                    ...
                    function a(a) {
                        ...
                        for (var k in c)
                            Object.prototype.hasOwnProperty.call(c, k) && d.setAttribute(k, c[k]);
                ...
                __d("PluginTags", ["PluginAttrTypes"], (function (a, b, c, d, e, f) {
                    var g = {
                        ...
                        lwi_ads_creation: {
                            fbe_extras: a.string,
                            fbe_redirect_uri: a.string,
                            fbe_scopes: a.string,
                            fbe_state: a.string,
                            hide_manage_button: a.bool
                        },
                        lwi_ads_insights: {
                            fbe_extras: a.string,
                            fbe_redirect_uri: a.string,
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1003109329","namespace":"FB","message":"' + e.message + '"}}');
}
